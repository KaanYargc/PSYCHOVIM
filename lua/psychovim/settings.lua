...
local rows = {
  ...
  { key = "lsp_lua", name = "LSP: Lua" },
  { key = "lsp_python", name = "LSP: Python" },
  { key = "lsp_typescript", name = "LSP: TypeScript / JS" },
  { key = "lsp_go", name = "LSP: Go" },
  { key = "lsp_rust", name = "LSP: Rust" },
  { key = "formatting", name = "Formatter engine" },
  { key = "autoformat", name = "Format on save" },
  { key = "linting", name = "Linter engine" },
  { key = "lint_on_save", name = "Lint on save" },
  ...
  { section = "TERMINAL" },
  { key = "terminal_numbers", name = "Terminal line numbers" },
  { key = "terminal_signcolumn", name = "Terminal sign column" },
  { key = "terminal_start_insert", name = "Terminal starts in insert" },
  ...
  { key = "auto_update_plugins", name = "Plugin/tool update on launch" },
  { key = "auto_update_parsers", name = "Parser update on launch" },
  { key = "plugin_update_check", name = "Lazy background checker" },
}
